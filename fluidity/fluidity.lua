...
setenv("PETSC_DIR","/mnt/lustre/groups/env-tsunami-2019/petsc-3.13.6/")
prepend_path("PYTHONPATH","/mnt/lustre/groups/env-tsunami-2019/lib/python3.6/site-packages")
prepend_path("PATH","/mnt/lustre/groups/env-tsunami-2019/bin/")
setenv("LDFLAGS","-L/mnt/lustre/groups/env-tsunami-2019/lib/ -L/mnt/lustre/groups/env-tsunami-2019/lib64/")
prepend_path("LD_LIBRARY_PATH","/mnt/lustre/groups/env-tsunami-2019/lib/")
prepend_path("LD_LIBRARY_PATH","/mnt/lustre/groups/env-tsunami-2019/lib64/")
setenv("PYTHONPATH","/mnt/lustre/groups/env-tsunami-2019/python")
