...
load("compiler/GCC/9.3.0")
load("devel/Autoconf/2.69-GCCcore-9.3.0")
load("devel/Automake/1.16.1-GCCcore-9.3.0")
load("lang/Python/3.8.2-GCCcore-9.3.0")
load("devel/CMake/3.16.4-GCCcore-9.3.0")
load("tools/git/2.23.0-GCCcore-9.3.0-nodocs")
load("lib/libtool/2.4.6-GCCcore-9.3.0")
load("lang/Bison/3.5.3-GCCcore-9.3.0")
load("mpi/MPICH/3.4.1-GCC-9.3.0")
prepend_path("PATH","/users/jh1889/scratch/gdal/bin")
prepend_path("LD_LIBRARY_PATH","/users/jh1889/scratch/gdal/lib")
prepend_path("LD_LIBRARY_PATH","/users/jh1889/scratch/lapack")
setenv("GDAL_DATA","-L/users/jh1889/scratch/gdal/share/gdal")
prepend_path("LIBRARY_PATH","/users/jh1889/scratch/lapack")
setenv("LAPACK","/users/jh1889/scratch/lapack")
