...
unload("mpi/MPICH/3.4.1-GCC-9.3.0")
...
prepend_path("LD_LIBRARY_PATH","/mnt/lustre/groups/env-tsunami-2019/mpich_3.4.2/lib")
prepend_path("LIBRARY_PATH","/mnt/lustre/groups/env-tsunami-2019/mpich_3.4.2/lib")
prepend_path("PATH","/mnt/lustre/groups/env-tsunami-2019/mpich_3.4.2/bin")
